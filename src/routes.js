...
import DefiDepositNEC from './views/DefiDepositNEC/DefiDepositNEC.vue';
import DefiBorrowNUSD from './views/DefiBorrowNUSD/DefiBorrowNUSD.vue';
import DefiDepositNECConfirmation from './views/DefiDepositNECConfirmation/DefiDepositNECConfirmation.vue';
...
import DefiBorrowNUSDConfirmation from './views/DefiBorrowNUSDConfirmation/DefiBorrowNUSDConfirmation.vue';
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    /*{
                        name: 'staking-unstake-nec',
                        path: 'detail/:stakerId/undelegate',
                        component: UnstakeNEC,
                    },*/
                    {
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        name: 'defi-borrow-nusd',
                        path: 'manage-nusd',
                        component: DefiBorrowNUSD,
                    },
                    {
                        name: 'defi-borrow-nusd-confirmation',
                        path: 'manage-nusd/confirmation',
                        component: DefiBorrowNUSDConfirmation,
                    },
                    {
                        name: 'defi-borrow-nusd-confirmation2',
                        path: 'manage-nusd/confirmation2',
                        component: DefiBorrowNUSDConfirmation,
                    },
                    {
                        name: 'defi-borrow-nusd-transaction-success-message',
                        path: 'manage-nusd/confirmation/success',
                        component: TransactionSuccessMessageView,
                    },
                    {
                        name: 'defi-borrow-nusd-transaction-success-message2',
                        path: 'manage-nusd/confirmation2/success2',
                        component: TransactionSuccessMessageView,
                    },
                    {
                        name: 'defi-borrow-nusd-transaction-reject-message',
                        path: 'manage-nusd/confirmation/reject',
                        component: TransactionRejectMessageView,
                    },
                    {
                        name: 'defi-borrow-nusd-transaction-reject-message2',
                        path: 'manage-nusd/confirmation2/reject2',
                        component: TransactionRejectMessageView,
                    },
                ],
            },
