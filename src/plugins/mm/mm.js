...
const NCOGEARTHCHAIN_CHAIN_ID = appConfig.chainId;

/** @type {MMChain} */
export const NCOGEARTHCHAIN_MAINNET = {
    chainId: appConfig.mainnet.chainId,
    chainName: 'Ncogearthchain Ncogearthchain Mainnet',
    nativeCurrency: {
        name: 'Ncogearthchain',
        symbol: 'NEC',
        decimals: 18,
...
/** @type {MMChain} */
export const NCOGEARTHCHAIN_TESTNET = {
    chainId: appConfig.testnet.chainId,
    chainName: 'Ncogearthchain Testnet',
    nativeCurrency: {
        name: 'Ncogearthchain',
        symbol: 'NEC',
        decimals: 18,
...
export class MM {
     ...
     */
    isCorrectChainId() {
        return this._provider && this._provider.chainId === NCOGEARTHCHAIN_CHAIN_ID;
    }
