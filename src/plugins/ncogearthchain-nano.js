// Basic functions for communication with ncogearthchain nano ledger hw, using ncogearthchain-ledgerjs

import NcogearthchainNano from 'ncogearthchain-ledgerjs/src/ncogearthchain-nano.js';
...
export class FNano {
    ...
    async getVersion() {
        ...
        if (transport) {
            ...
            const bridge = new NcogearthchainNano(transport);
