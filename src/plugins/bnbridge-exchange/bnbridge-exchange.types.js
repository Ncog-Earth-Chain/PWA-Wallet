 ...
 * @property {boolean} nec_enabled
 * @property {boolean} listed
 * @property {boolean} listing_proposed
 * @property {boolean} ncogearthchain_enabled
 ...
 * @typedef {('NcogearthchainToBinance' | 'EthereumToBinance' | 'NcogearthchainToEthereum' | 'BinanceToNcogearthchain' | 'BinanceToEthereum' | 'EthereumToNcogearthchain')} BNBridgeDirection
 */
