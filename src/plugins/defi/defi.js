...
export class DeFi {
    ...
    _setTokens(_tokens) {
        this.tokens = _tokens;
        this.nusdToken = _tokens.find((_item) => _item.symbol === 'NUSD');
    ...
    getMaxDebtNUSD(_collateralNUSD) {
        return _collateralNUSD > 0 ? _collateralNUSD / this.minCollateralRatio : 0;
    }
    ...
    getMintingLimitNUSD(_debt, _collateralNUSD) {
        // ratio between actual debt and liquidation debt
        return _collateralNUSD > 0 ? (_debt / (_collateralNUSD / this.liqCollateralRatio)) * 100 : 0;
    }
    ...
    /**
     * Get overall debt in NUSD.
     *
     * @param {FMintAccount} _fMintAccount
     * @return {number}
     */
    getOverallDebt(_fMintAccount) {
        return this.fromTokenValue(_fMintAccount.debtValue, this.nusdToken);
    }

    /**
     * Get overall collateral in NUSD.
     *
     * @param {FMintAccount} _fMintAccount
     * @return {number}
     */
    getOverallCollateral(_fMintAccount) {
        return this.fromTokenValue(_fMintAccount.collateralValue, this.nusdToken);
    }

    /**
     * Get overall borrow limit in NUSD.
     *
     * @param {FMintAccount} _fMintAccount
     * @return {number}
     */
    getBorrowLimit(_fMintAccount) {
        ...
        return this.getMaxDebtNUSD(overallCollateral) - overallDebt;
    }
    ...
    /**
     * Get overall debt limit in NUSD.
     *
     * @param {FMintAccount} _fMintAccount
     * @param {number} [_currDebtNUSD] Current debt in NUSD.
     * @param {number} [_currCollateralNUSD] Current corrateral in NUSD.
     * @return {number}
     */
    getDebtLimit(_fMintAccount, _currDebtNUSD = 0, _currCollateralNUSD = 0) {
        const overallDebt = this.getOverallDebt(_fMintAccount);
        const overallCollateral = this.getOverallCollateral(_fMintAccount);

        return this.getMintingLimitNUSD(_currDebtNUSD + overallDebt, _currCollateralNUSD + overallCollateral);
    }
     ...
     * @return {number}
     */
    getCollateralRatio(_fMintAccount, _currDebtNUSD = 0, _currCollateralNUSD = 0) {
        const overallDebt = this.getOverallDebt(_fMintAccount);
        const overallCollateral = this.getOverallCollateral(_fMintAccount);

        return (
            (overallDebt + _currDebtNUSD > 0
                ? (overallCollateral + _currCollateralNUSD) / (overallDebt + _currDebtNUSD)
                : 0) * 100
        );
    }
    ...
    canTokenBeMinted(_token) {
        // return _token && _token.isActive && _token.canMint && _token.symbol !== 'NUSD';
    ...
    canTokenBeBorrowed(_token) {
        // return _token && _token.isActive && _token.canBorrow && _token.symbol !== 'NUSD';
    ...
    canTokenBeTraded(_token) {
        ...
        // return _token && _token.isActive && (_token.canTrade || _token.symbol === 'NUSD');
    }
