<template>
    <div class="delegation-unlock-confirmation">
        <tx-confirmation
            ...
            password-label="Please enter your wallet password to unlock your delegated NEC"
            set-tmp-pwd
        ...
        >
            <h2 class="not-visible" data-focus>Unlock NEC - Confirmation</h2>
...
export default {
    ...
    props: {
        ...
        /** Unlock maximal amount of NEC tokens */
        undelegateMax: {
            type: Boolean,
            default: false,
        },
