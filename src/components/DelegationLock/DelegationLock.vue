...
export default {
    ...
    methods: {
        async init() {
            ...
            this.amountDelegated = parseFloat(this.$fWallet.WEIToNEC(this.delegation.amountDelegated));
        ...
        checkAmount(_value) {
            ...
            if (!isNaN(value)) {
                if (value <= amountDelegated && value >= 1) {
                    ...
                    this.amountErrMsg = `You can't lock amount less than 1 NEC`;
                } else if (value >= 1) {
                    this.amountErrMsg = `You can lock max ${amountDelegated} NEC`;
                }
            }
