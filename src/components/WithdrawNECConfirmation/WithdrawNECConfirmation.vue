<template>
    <div class="withdraw-nec-confirmation">
        <tx-confirmation
            :tx="tx"
            confirmation-comp-name="withdraw-nec-confirmation"
            send-button-label="Withdraw"
            password-label="Please enter your wallet password to withdraw your NEC"
        ...
        >
            <h2 class="not-visible" data-focus>Withdraw delegated NEC - Confirmation</h2>
...
export default {
    name: 'WithdrawNECConfirmation',

    components: { NECTokenValue, LedgerConfirmationContent, TxConfirmation },

    props: {
        /** `accountInfo` object from `UnstakeNEC` component. */
        accountInfo: {
            type: Object,
            default() {
                return {};
        ...
        /** Amount of NEC tokens to withdraw */
        amount: {
            type: Number,
            default: 1,
        },
    ...
    methods: {
        ...
        onSendTransactionSuccess(_data) {
            this.$emit('change-component', {
                to: 'staking-withdraw-nec-confirmation-success-message',
                from: 'withdraw-nec-confirmation',
                data: {
