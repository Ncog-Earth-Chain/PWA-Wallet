<template>
    <div class="tx-confirmation">
        ...
        >
            ...
            <div class="align-center"><img src="img/nano-s-confirm-tx.png" alt="ncogearthchain nano device" /><br /><br /></div>
...
import { U2FStatus } from '../../plugins/ncogearthchain-nano.js';
        ...
        async onFFormSubmit(_event) {
            ...
            if (currentAccount && this.tx && fWallet.isValidAddress(this.tx.to)) {
                ...
                if (data.gasLimit && data.gasPrice) {
                    this.$store.commit(
                        SET_TX_FEE,
                        fWallet.WEIToNEC(fWallet.getTransactionFee(data.gasPrice, data.gasLimit))
                    );
                } else {
