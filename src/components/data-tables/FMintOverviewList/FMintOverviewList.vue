...
export default {
    ...
    methods: {
        ...
        async addRows(_account) {
            ...
            const tokens = result[1].filter((_item) => _item.isActive && _item.symbol !== 'NEC');

            this.wnecToken = tokens.find((_item) => _item.symbol === 'WNEC');
            ...
            const items = tokens.filter((_item) => {
                ...
                if ((collateral !== 0 || debt !== 0) && _item.symbol !== 'WNEC' && _item.symbol !== 'SNEC') {
