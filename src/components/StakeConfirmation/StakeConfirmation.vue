<template>
    <div class="stake-confirmation">
        <tx-confirmation
            ...
            password-label="Please enter your wallet password to delegate your NEC"
        ...
        >
            <h2 class="not-visible" data-focus>Delegate NEC</h2>
...
export default {
    ...
    props: {
        /** Data sent from StakeForm component. Info about transaction, validator and amount of NEC. */
        stakeData: {
            type: Object,
            default() {
                return {};
