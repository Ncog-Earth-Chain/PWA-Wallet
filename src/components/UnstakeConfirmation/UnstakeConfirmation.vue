<template>
    <div class="unstake-confirmation">
        <tx-confirmation
            ...
            password-label="Please enter your wallet password to undelegate your NEC"
        ...
        >
            <h2 class="not-visible" data-focus>Undelegate NEC - Confirmation</h2>
            ...
            <div class="transaction-info">
                ...
                <f-message v-if="amountDiff > 0" type="warning"> {{ amountDiff }} NEC slashing applied </f-message>
            </div>
...
export default {
    ...
    components: { NECTokenValue, FMessage, LedgerConfirmationContent, TxConfirmation },
    ...
    props: {
        ...
        /** Amount of NEC tokens to unstake */
        amount: {
            type: Number,
            default: 1,
        },
        /** Amount of NEC tokens to unlock. (hex number) */
        toUnlockAmount: {
            type: String,
            default: '',
        },
        /** Unstake maximal amount of NEC tokens */
        undelegateMax: {
            type: Boolean,
            default: false,
        },
