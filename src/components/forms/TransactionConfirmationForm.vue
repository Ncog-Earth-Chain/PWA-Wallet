            ...
            <fieldset class="">
                ...
                <div class="form-body">
                    ...
                    <div class="align-center form-buttons">
                        ...
                        <div v-if="notEnoughNEC">
                            <f-message type="warning" with-icon class="align-start">
                                Warning: Not enough available NEC for gas fees. Transfer NEC to your address to proceed.
                            </f-message>
                            <br />
                        </div>

                        <p class="max-fee" tabindex="0">Max Fee: {{ dMaxFee }} NEC</p>
                        ...
                        <template v-if="!waiting">
                            ...
                            <FButton
                                ...
                                style="max-width: 100%;"
                                :disabled="notEnoughNEC || disabledSubmit"
                            >
                                {{ sendButtonLabel }}
                            </FButton>
