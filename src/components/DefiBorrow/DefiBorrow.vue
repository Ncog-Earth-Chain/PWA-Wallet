            ...
            <div>
                ...
                <template v-if="!largeView">
                    <div class="df-data-item smaller">
                        ...
                        <div class="value">
                            <f-token-value :token="nusdToken" :value="collateralInNUSD" />
                        </div>
                    </div>
                </template>
-->
...
export default {
    ...
    computed: {
        ...
        tokenDebt() {
            ...
            return this.$defi.fromTokenValue(tokenBalance.balance, this.dToken) || 0;
            // console.log(this.$defi.fromTokenValue(this.fMintAccount.debtValue, this.nusdToken));
            // return this.$defi.fromTokenValue(this.fMintAccount.debtValue, this.nusdToken);
        },

        /**
         * Temporarily take NEC as collateral.
         *
         * @return {number}
         */
        collateral() {
        ...
        collateralInNUSD() {
            return (this.collateral * this.$defi.getTokenPrice(this.wnecToken)).toFixed(2);
        ...
        currDebtNUSD() {
            // const currDebtNUSD = parseFloat(this.currDebt) * this.tokenPrice;
            const debt = parseFloat(this.debt);
            const debtNUSD = debt * this.tokenPrice;
            ...
            return cDebt * this.tokenPrice - debtNUSD;
        },

        debtLimit() {
            return this.$defi.getDebtLimit(this.fMintAccount, this.currDebtNUSD);
        },

        collateralRatio() {
            return this.$defi.getCollateralRatio(this.fMintAccount, this.currDebtNUSD);
        },
    ...
    methods: {
        async init(_dontSetDToken) {
            ...
            this.nusdToken = tokens.find((_item) => _item.symbol === 'NUSD');
            ...
            if (!_dontSetDToken) {
                if (this.token === null) {
                    if (this.tokenAddress) {
                        ...
                        this.dToken = tokens.find((token) => token.symbol === 'NUSD');
                    }
                } else {
