<template>
    <div class="claim-rewards-confirmation">
        ...
        >
            ...
            <div class="transaction-info">
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col break-word">
                        <f-placeholder :content-loaded="!!dAccountInfo.stakerId" :replacement-num-chars="14">
                            <template v-if="dAccountInfo.stakerId">
                                <n-e-c-token-value :value="dAccountInfo.delegation.pendingRewards.amount" convert />
                            </template>
                        </f-placeholder>
                    </div>
                </div>
            ...
            >
                Staking limit reached. You can restake max {{ delegatedLimit }} NEC on validator
                {{ dAccountInfo.stakerInfo.stakerInfo.name }}, {{ dAccountInfo.stakerId }}
            </f-message>
...
<script>
import { toNEC, WEIToNEC } from '@/utils/transactions.js';
import { mapGetters } from 'vuex';
import sfcUtils from 'ncogearthchain-ledgerjs/src/sfc-utils.js';
import TxConfirmation from '../TxConfirmation/TxConfirmation.vue';
import { SFC_CLAIM_MAX_EPOCHS } from '@/plugins/ncogearthchain-web3-wallet.js';
...
export default {
    ...
    components: { NECTokenValue, FMessage, FPlaceholder, LedgerConfirmationContent, TxConfirmation },
    ...
    methods: {
        delegatedLimitReached() {
            ...
            this.delegatedLimit = parseFloat(this.$fWallet.WEIToNEC(delegatedLimit)).toFixed(2);
