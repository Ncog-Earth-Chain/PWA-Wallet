            ...
            <div class="col balances">
                <div class="balance">
                    <h3 class="align-center-lg">
                        ...
                        <span>
                            <n-e-c-token-value :value="accountsBalance" no-currency />
                ...
                <div class="balance total-balance">
                    <h3 class="align-center-lg">
                        ...
                        <span>
                            <n-e-c-token-value :value="accountsTotalBalance" no-currency />
                            <span class="nec"> NEC</span>
                        </span>
                    </h3>
                    <div class="currency">
...
export default {
    ...
    components: { NECTokenValue, DashboardActionsBox, FCard },
