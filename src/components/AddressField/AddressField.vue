...
export default {
    ...
    props: {
        ...
        blockchain: {
            type: String,
            default: 'ncogearthchain',
            validator: function (_value) {
                return ['ncogearthchain', 'ethereum', 'binance'].indexOf(_value) !== -1;
            },
        },
    },
    ...
    methods: {
        setAddAddressBtnVisibility(_address) {
            this.addAddressBtnVisible =
                ...
                !(
                    (this.blockchain === 'ncogearthchain' && this.getAccountAndIndexByAddress(_address).index !== -1) ||
