                    ...
                    <h3 slot="title" class="title">
                        <span class="row no-collapse align-items-start">
                            ...
                            <span class="col col-6-md">
                                <span class="value">
                                    <n-e-c-token-value :value="account.balance" convert no-currency />
                                    <span class="nec"> NEC</span>
                                </span>
                                <span class="currency">
                                    <n-e-c-token-value
                                        :value="WEIToNEC(account.balance) * tokenPrice"
                                        with-price-currency
                                        no-currency
                                    />
                                </span>
                            ...
                            <span class="col col-6-md">
                                <span class="value">
                                    <n-e-c-token-value :value="account.totalBalance" convert no-currency />
                                    <span class="nec"> NEC</span>
                                </span>
                                <span class="currency">
                                    <n-e-c-token-value
                                        :value="WEIToNEC(account.totalBalance) * tokenPrice"
                                        with-price-currency
                                        no-currency
                                    />
                                </span>
...
export default {
    ...
    components: { NECTokenValue, FCopyButton, AccountName, AccountSettingsWindow, FCard },
