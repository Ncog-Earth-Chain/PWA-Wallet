...
-->
        ...
        <div class="se-cont">
            ...
            <div class="exchange-price">
                ...
                <div class="value">
                    <f-placeholder :content-loaded="!!perPrice" replacement-text="000.00 nusd per fETH">
                        {{ perPrice }}
                    </f-placeholder>
                </div>
...
export default {
    ...
    methods: {
        async init() {
            ...
            const wNEC = result[1].filter((_token) => _token && _token.canWrapNEC);
            ...
            const necToken = {
                ...
                decimals: 18,
                price: wNEC[0].price,
                priceDecimals: wNEC[0].priceDecimals,
                availableBalance: account.balance,
                allowance: '0x0',
                logoUrl: 'https://cryptologos.cc/logos/ncogearthchain-nec-logo.svg?v=003',
            };
            this.$defi._setTokenDecimals(necToken);

            // add NEC
            result[1].unshift(necToken);

            this.tokens = result[1].filter((_token) => _token && (_token.symbol === 'NEC' || _token.canWrapNEC));
        ...
        onSubmit() {
            ...
            if (fromToken.canWrapNEC && toToken.symbol === 'NEC') {
                this.stepsCount = 2;
