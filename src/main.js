...
import { NcogearthchainWeb3Wallet } from './plugins/ncogearthchain-web3-wallet.js';
import { BNBridgeExchange } from './plugins/bnbridge-exchange/bnbridge-exchange.js';
import { FNano } from './plugins/ncogearthchain-nano.js';
...
Vue.use(FFetch);
Vue.use(NcogearthchainWeb3Wallet, {
    apolloClient,
});
