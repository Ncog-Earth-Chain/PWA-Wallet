 ...
 * by an array of token addresses. If you want to use native NEC token
 * on the input, or output, use Wrapped NEC token address instead.
 *
 * @param {Web3} web3
 * @param {string} routerAddress
...
/**
 * uniswapAddLiquidityNec creates a contract call transaction to add liquidity
 ...
 * @param {string|{BN}} amountNecDesired
 * @param {string|{BN}} amountTokenMin
 * @param {string|{BN}} amountNecMin
 * @param {string} to
 * @param {string|{BN}} deadline
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapAddLiquidityNec(
    web3,
    routerAddress,
    token,
    amountTokenDesired,
    ...
    return {
        to: routerAddress,
        value: web3Utils.numberToHex(amountNecDesired),
        data: web3.eth.abi.encodeFunctionCall({
            "constant": false,
            "inputs": [
                {
            ...
            "type": "function"
        }, [token, amountTokenDesired, amountTokenMin, amountNecMin, to, deadline])
    };
}
...
/**
 * uniswapRemoveLiquidityNec creates a contract call transaction to remove liquidity
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapRemoveLiquidityNec(
    web3,
    routerAddress,
    token,
    liquidity,
    ...
    return {
        ...
        data: web3.eth.abi.encodeFunctionCall({
            ...
            "stateMutability": "nonpayable",
            "type": "function"
        }, [token, liquidity, amountTokenMin, amountNecMin, to, deadline])
    };
}
...
/**
 * uniswapExactNecForTokens creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the Wrapped Native NEC one and the last token is the exit one.
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactNecForTokens(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
/**
 * uniswapNecForExactTokens creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the Wrapped Native NEC and the last token is the exit one.
 * The output amount is exact and the input amount is specified by maximal allowed
 * quantity. Fuzziness of the call is towards the input. Native NEC tokens
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapNecForExactTokens(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
...
/**
 * uniswapTokensForExactNec creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the entry one and the last token is the Wrapped NEC. The output
 * amount is exact and the input amount is specified by maximal allowed quantity.
 * Fuzziness of the call is towards the input. Sufficient allowance is required
 * on input token to cover the max amount offered. Native NEC is returned on success.
 *
 * @param {Web3} web3
 * @param {string} routerAddress
 * @param {string|{BN}} amountOut
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapTokensForExactNec(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
...
/**
 * uniswapExactTokensForNec creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the entry one and the last token is the Wrapped NEC. The input
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactTokensForNec(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
export default {
    ...
    /*********** liquidity ***********/
    uniswapAddLiquidity,
    uniswapAddLiquidityNec,
    uniswapRemoveLiquidity,
    uniswapRemoveLiquidityNec,
    uniswapApproveShareTransfer,

    /*********** SWAP calls **********/
    uniswapExactTokensForTokens,
    uniswapExactNecForTokens,
    uniswapTokensForExactTokens,
    uniswapNecForExactTokens,
    uniswapTokensForExactNec,
    uniswapExactTokensForNec,
};
